...
using EventSourcingExample.WebUI.Helpers;
using FluentValidation;

namespace EventSourcingExample.WebUI.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                { typeof(DomainLogicException), HandleDomainLogicException },
            };
        }
        ...
        private void HandleDomainLogicException(ExceptionContext context)
        {
            var details = new ProblemDetails
            {
                Status = StatusCodes.Status500InternalServerError,
                Title = "Domain logic validated",
